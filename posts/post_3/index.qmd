...
Modelde, `alpha` değerini 0.01 aldığımızda değişen varyans yoktur.
...
%50.57 - %51.32 tahmin aralığında %50.95'lik bir oy öngörüsünde bulunabiliriz. Gerçek oy oranı %51.14'tür. Öngörü, gerçek oyun yaklaşık 0.19 puan kadar altında kalmıştır ancak fena olmadığını söyleyebiliriz. Bu öngörüyü açılan sandık oranı %49 iken yaptık.
