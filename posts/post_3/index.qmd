...
Yapacağımız uygulamada İstanbul ilini ve Anadolu Ajansı verilerini baz alacağız. Verileri 31 Mart 2024 akşamı izlediğim NOW kanalından aldım. Veri seti, açılan sandık oranı ve adayların oy oranları ile aralarındaki farkları içermektedir. Veri setine [buradan](https://github.com/urazakgul/python-blog/tree/main/posts/post_3){.external target="_blank"} ulaşabilirsiniz.
